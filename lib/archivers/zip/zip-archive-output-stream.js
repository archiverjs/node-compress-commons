...
ZipArchiveOutputStream.prototype._writeCentralDirectoryZip64 = function() {
  var needs64 = this._entries.length > constants.ZIP64_MAGIC_SHORT || this._archive.centralLength > constants.ZIP64_MAGIC || this._archive.centralOffset > constants.ZIP64_MAGIC;
  ...
  this.write(zipUtil.getEightBytes((constants.SHORT * 2) + (constants.WORD * 2) + (constants.DWORD * 4)));
...
ZipArchiveOutputStream.prototype._writeCentralFileHeader = function(ae) {
  ...
  this.write(zipUtil.getShortBytes(
    (ae.getPlatform() << 8) | constants.MIN_VERSION_DATA_DESCRIPTOR
  ));
