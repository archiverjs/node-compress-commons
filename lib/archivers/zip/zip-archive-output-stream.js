...
ZipArchiveOutputStream.prototype._writeCentralDirectoryEnd = function() {
  var records = this.isZip64() ? constants.ZIP64_MAGIC_SHORT : this._entries.length;
  var size = this.isZip64() ? constants.ZIP64_MAGIC : this._archive.centralLength;
  var offset = this.isZip64() ? constants.ZIP64_MAGIC : this._archive.centralOffset;
...
ZipArchiveOutputStream.prototype._writeCentralDirectoryZip64 = function() {
  ...
  // version made by
  this.write(zipUtil.getShortBytes((ae.getPlatform() << 8) | constants.MIN_VERSION_ZIP64));
